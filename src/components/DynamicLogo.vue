...
function handleLogoClick(logoItem: LogoImg) {
  if (particleCanvas.value) {
    clickLogo(particleCanvas.value, logoItem);
  } else {
    console.warn('ParticleCanvas is not initialized.');
  }
}
...
<template>
  ...
  <ul class="logo-options-container">
    <li
      ...
      @click="handleLogoClick(logoItem)"
      data-cursor="pointer"
    >
